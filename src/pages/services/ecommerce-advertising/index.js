        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed">
              Expert management of Amazon PPC, Facebook Business Manager, and
              multi-platform e-commerce advertising campaigns. Drive ROI with
              data-driven optimization across Amazon, Flipkart, Meesho, and
              more.
            </p>
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Get a free PPC audit worth ₹20,000
            </p>
  ...
  const services = [
    {
      ...
      icon: ShoppingBag,
      description:
        "Expert Amazon advertising campaign management with automatic & manual campaign optimization for maximum ROI.",
      features: [
    ...
    },
    {
      ...
      icon: Users,
      description:
        "Strategic Facebook ad campaign management and Instagram ads for e-commerce business growth.",
      features: [
    ...
    },
    {
      ...
      icon: Search,
      description:
        "Comprehensive e-commerce marketing across Google Ads, Flipkart, and Meesho platforms.",
      features: [
  ...
  const features = [
    {
      ...
      description:
        "Expert optimization of Amazon PPC, Facebook ads, and Google Ads campaigns for maximum ROI.",
    },
    {
      icon: LineChart,
      title: "E-commerce Campaign Management",
      description:
        "Comprehensive management of advertising campaigns across Amazon, Flipkart, and Meesho.",
    },
    {
      icon: Settings,
      title: "Automated Bid Management",
      description:
        "Smart bid optimization for Amazon PPC, Google Ads, and Facebook Business Manager.",
    },
    {
      icon: DollarSign,
      title: "Strategic Budget Allocation",
      description:
        "Efficient management of PPC daily budgets across all e-commerce platforms.",
    },
    {
      icon: BarChart,
      title: "Cross-Platform Analytics",
      description:
        "Unified tracking and optimization of marketing campaigns across multiple channels.",
    },
    {
      icon: PieChart,
      title: "Multi-Platform Integration",
      description:
        "Seamless integration of advertising campaigns across all major e-commerce platforms.",
    },
  ];
  ...
  const studies = [
    {
      ...
      description:
        "Optimized Amazon PPC campaigns and Facebook ad strategy for maximum ROAS",
    },
    {
      ...
      description:
        "Integrated Google Ads and Flipkart advertising campaigns for optimal performance",
    },
    {
      ...
      description:
        "Strategic e-commerce advertising across Instagram and Meesho platforms",
    },
  ];
    ...
    <section className="py-24 bg-gradient-to-br from-orange-50 to-orange-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-700">
            Comprehensive advertising solutions across all major e-commerce
            platforms
          </p>
        </div>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-12">
              Join 500+ brands achieving exceptional results across 9+
...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We implement a hybrid approach using both automatic and manual campaigns. Automatic campaigns are used for keyword discovery and data collection, while manual campaigns are optimized based on performance data. We regularly analyze search terms, adjust bids, and optimize targeting to maximize campaign effectiveness.",
    },
    {
      question: "What strategies do you use for brand campaigns?",
      answer:
        "Our brand campaign strategies include Amazon sponsored brand campaigns, Facebook brand awareness campaigns, and Google brand campaigns. We focus on creating cohesive brand messaging across all platforms while optimizing for both visibility and conversion rates.",
    },
    {
      question: "How do you optimize product targeting and keywords?",
      answer:
        "We conduct thorough keyword research and implement strategic product targeting across all platforms. This includes optimizing Amazon PPC keywords, Google Ads search terms, and Facebook audience targeting. We regularly analyze search term reports and adjust targeting based on performance data.",
    },
    {
      question: "What's your approach to bid management?",
      answer:
        "We use advanced bid management software and strategies to optimize bids across all platforms. This includes automated bid adjustments based on performance data, dayparting, and competitive analysis. Our approach ensures optimal bid levels for maximum ROAS.",
    },
    {
      question: "How do you handle attribution and tracking?",
      answer:
        "We implement comprehensive attribution tracking including Amazon Attribution, Facebook Pixel, and Google Analytics. This allows us to accurately measure campaign performance across all channels and make data-driven optimization decisions.",
    },
    {
      question: "What kind of results can we expect?",
      answer:
        "While results vary by industry and competition, our clients typically see significant improvements in ROAS, reduced ACoS, and increased sales velocity. We focus on delivering measurable results through strategic campaign optimization and continuous performance monitoring.",
    },
  ].map((faq) => ({
    ...faq,
...
const EcommerceAdvertisingPage = () => {
  return (
    <>
      <Head>
        <title>
          Ecommerce Advertising Services | Amazon, Facebook & Google Ads |
          Technovita
        </title>
        <meta
          name="description"
          content="Expert ecommerce advertising services across Amazon, Facebook, Google & other marketplaces. PPC optimization, campaign management, sponsored ads & ROI-focused strategies for online sellers."
        />
        <meta
          name="keywords"
          content="ecommerce advertising services, amazon ppc management, facebook ad campaigns, google ads optimization, marketplace advertising, amazon sponsored ads, ppc campaign optimization, facebook business manager, ecommerce marketing strategy, amazon advertising optimization, flipkart ad campaigns, meesho advertising, campaign management tools, automated bid management, ecommerce ppc services, sponsored brand campaigns, digital marketing campaign management, marketplace advertising solutions, amazon seller advertising, facebook ads for ecommerce"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Complete Ecommerce Advertising Solutions | Multi-Platform Campaign Management"
        />
        <meta
          property="og:description"
          content="Professional ecommerce advertising services across Amazon, Facebook & Google. Expert PPC management, campaign optimization & marketplace advertising solutions for maximum ROI."
        />
