...
export default function AjioSellerLanding() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/ajio-seller', {
        method: 'POST',
        headers: {
  ...
  const testimonials = [
    {
      id: 1,
      name: "Rajesh Kumar",
      title: "Boosted Sales by 250%",
      videoUrl: "https://www.youtube.com/embed/0KtKwVq39Y4",
      description: "With their Ajio onboarding service, our monthly orders increased from 50 to 175 in just 3 months!"
    },
    {
      id: 2,
      name: "Priya Sharma",
      title: "From Startup to 150 Orders/Day",
      videoUrl: "https://www.youtube.com/embed/eoCYSK0p-A8",
      description: "Their Ajio listing optimization and photography services transformed our brand visibility."
    },
    {
      id: 3,
  ...
  return (
    <>
      <Head>
        <title>Ajio Seller Registration | Launch Your Brand on Ajio in 14 Days</title>
        <meta name="description" content="Get expert assistance for Ajio seller account registration. Complete onboarding service including documentation, verification, product photography, listing and sales strategy for Ajio marketplace." />
        <meta name="keywords" content="ajio seller registration, ajio seller account, sell on ajio, ajio onboarding, ajio product listing, ajio marketplace, ajio seller portal, ajio vendor registration" />
        <meta property="og:title" content="Ajio Seller Registration | Launch Your Brand on Ajio" />
        <meta property="og:description" content="Complete Ajio seller onboarding service to help fashion brands launch on Ajio marketplace with hassle-free verification and account setup." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://technovitasolution.com/ajio-seller-account-registration" />
      ...
      <div className="bg-white min-h-screen flex flex-col items-center justify-start">
        ...
        <section className="w-full bg-white py-12 md:py-16 px-4 flex flex-col items-center text-center relative overflow-hidden" aria-labelledby="hero-heading">
          <div className="max-w-5xl z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 mb-6 md:mb-8">
              ...
              >
                ...
                Chat With Ajio Expert
              </a>
              <button 
                onClick={scrollToForm}
                className="bg-transparent border-2 border-orange-600 text-orange-600 font-bold px-8 py-4 rounded-lg hover:bg-orange-50 transition w-full sm:w-auto"
              >
          ...
          <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-orange-100 opacity-20 rounded-full"></div>
          <div className="absolute top-10 -left-10 w-32 h-32 bg-red-100 opacity-20 rounded-full"></div>
        </section>
        ...
        <section className="w-full py-8 md:py-20 px-4 bg-white" aria-labelledby="testimonial-heading">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <span className="text-orange-600 font-medium text-sm uppercase tracking-wider mb-2 inline-block">Real Seller Success Stories</span>
              <h2 id="testimonial-heading" className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
                Trusted by <span className="text-orange-600">100+</span> Brands on Ajio
              </h2>
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
                Don't just take our word for it. See how these sellers transformed their businesses with our expert Ajio onboarding services.
              </p>
            </div>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  >
                    {videosLoaded[testimonial.id] ? (
                      ...
                      <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center bg-gray-100">
                        ...
                        <div className="w-16 h-16 rounded-full bg-orange-600 flex items-center justify-center cursor-pointer shadow-lg">
                  ...
                  <div className="p-6">
                    ...
                    <h4 className="font-medium text-orange-600 mb-2 text-lg">{testimonial.title}</h4>
            ...
            <div className="mt-12 text-center">
              <a 
                onClick={scrollToForm}
                className="inline-flex items-center justify-center bg-orange-600 border-2 border-orange-600 text-white font-bold px-8 py-4 rounded-lg hover:bg-orange-700 hover:border-orange-700 transition cursor-pointer"
              >
        ...
        <section className="w-full py-8 md:py-16 px-4" aria-labelledby="services-heading">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 id="services-heading" className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Your Complete Ajio Launch Solution</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">We handle every aspect of your Ajio seller journey, from application to your first sale.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-orange-500 hover:transform hover:scale-105 transition duration-300">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" role="img">
                    <title>Ajio Onboarding Icon</title>
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-center mb-2">Ajio Onboarding</h3>
                <p className="text-gray-600 text-center">We handle application, documentation, verification, and account setup for your Ajio seller account.</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-orange-500 hover:transform hover:scale-105 transition duration-300">
                ...
                <p className="text-gray-600 text-center">Get Ajio-compliant product photography that meets all marketplace requirements and boosts conversions.</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-orange-500 hover:transform hover:scale-105 transition duration-300">
                ...
                <p className="text-gray-600 text-center">Expert catalog creation with SEO optimized titles, descriptions, and perfect categorization for maximum visibility on Ajio.</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-orange-500 hover:transform hover:scale-105 transition duration-300">
                ...
                <p className="text-gray-600 text-center">Strategic pricing, promotions, and inventory planning to help you achieve your first sales quickly on Ajio.</p>
              </div>
            </div>
          </div>
        </section>    
        ...
        <section id="apply-form" ref={formSectionRef} className="w-full py-8 md:py-20 px-4 bg-gradient-to-br from-orange-50 to-white" aria-labelledby="form-heading">
          <div className="max-w-xs sm:max-w-lg mx-auto">
            <div className="text-center mb-12">
              <span className="text-orange-600 font-medium text-sm uppercase tracking-wider mb-2 inline-block">Start Selling Today</span>
              <h2 id="form-heading" className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Apply for Ajio Seller Verification
              </h2>
              <p className="text-lg text-gray-600 max-w-md mx-auto">
                Fill out this quick form and our experts will guide you through the entire Ajio onboarding process.
              </p>
            </div>
                  ...
                  <div key={step} className="flex flex-col items-center">
                    <div 
                      className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${
                        ...
                        step === formStep ? 'bg-orange-600 text-white' : 
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 flex items-center">
                            <span className="flex items-center justify-center h-full px-3 md:px-4 bg-orange-50 text-orange-600 font-medium border border-r-0 border-orange-300 rounded-l-full text-sm">
                              +91
                            </span>
                          </div>
                          <input 
                            ...
                            pattern="[0-9]{10}" 
                            maxLength="10"
                            className="block w-full pl-16 md:pl-20 pr-4 py-3 rounded-full border-orange-300 shadow-sm focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-gray-700 transition-all duration-200"
                      ...
                      <div className="mt-6">
                        <button 
                          ...
                          className="w-full bg-orange-600 text-white py-3 px-6 rounded-full font-medium hover:bg-orange-700 transition-all duration-300 shadow-md hover:shadow-lg text-base flex items-center justify-center"
                        >
                          Continue
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          id="name" 
                          name="name" 
                          className="block w-full rounded-full border-orange-300 shadow-sm focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-gray-700 transition-all duration-200 py-3 px-4"
                      ...
                      <div className="flex gap-2 mt-6">
                        ...
                        <button 
                          type="button" 
                          onClick={handleNextStep}
                          className="w-2/3 bg-orange-600 text-white py-3 px-1 md:px-6 rounded-full font-medium hover:bg-orange-700 transition-all duration-300 text-sm md:text-base flex items-center justify-center"
                        >
                          Continue
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <select
                          id="category"
                          name="category"
                          className="block w-full rounded-full border-orange-300 shadow-sm focus:ring-2 focus:ring-orange-200 focus:border-orange-500 text-gray-700 transition-all duration-200 py-3 px-4 appearance-none bg-white"
                  ...
                  {formStep === 3 && (
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-gray-600">
                        By submitting this form, you agree to be contacted by our Ajio seller experts regarding your onboarding process.
                      </p>
                      {submitError && (
                      ...
                      <div className="flex gap-2 mt-6">
                        ...
                        >
                          ...
                          ) : <span className="truncate whitespace-nowrap">Apply to Sell on Ajio</span>}
                        </button>
                      </div>
                    </div>
                  )}
            ...
            <div className="mt-8 text-center text-sm text-gray-500">
              <p>Enter correct details to get your Ajio seller account verified.</p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-8 md:py-20 px-4 bg-white text-gray-800 relative" aria-labelledby="guarantee-heading" style={{ 
          ...
          <div className="max-w-4xl mx-auto text-center">
            <h2 id="guarantee-heading" className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-10 leading-tight">
              Launch Your Brand on Ajio in Just <span className="text-orange-600">14 Days</span>
            </h2>
            ...
            <p className="text-xl md:text-2xl mb-6 md:mb-10 max-w-3xl mx-auto text-gray-700">
              Get guaranteed Ajio seller account approval with our end-to-end 
        ...
        <footer className="w-full py-6 bg-gray-900 text-white text-center text-sm">
          <div className="max-w-5xl mx-auto px-4">
            ...
            <p className="mt-2 text-gray-400">
              Your Ajio seller account is in safe hands. We provide seller onboarding services as independent consultants.
            </p>
          </div>
        </footer>
      </div>
      ...
      <script 
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Ajio Seller Account Registration Service",
            "description": "Complete Ajio seller onboarding service for fashion brands, including account verification, product photography, catalog listing, and sales strategy for Ajio marketplace.",
            "provider": {
              "@type": "Organization",
            ...
            "areaServed": "India",
            "serviceType": "Ajio Seller Onboarding",
            "termsOfService": "By submitting the form, you agree to be contacted by our Ajio seller experts."
          })
        }}
      />
    </>
